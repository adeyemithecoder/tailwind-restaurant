  ...
  return (
    ...
    <div className="max-w-[1170px] m-auto">
      <div className="flex flex-wrap">
        ...
        <h3 className='text-xl text-skin-main font-medium capitalize' > team</h3>
          <h2 className='text-4xl capitalize hover: '>Our Chiefs</h2>
        </div>
        <nav className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-full" >

          <div className=" px-4 lg:mb-9 sm:mb-8 group mb-16 relative">
            <img className='w-full transition duration-300 group-hover:skew-y-[5deg] rounded-lg hover:skew-y-6 ' src={img1} alt=""/>
            <div className="bg-skin-dark-light rounded-lg p-4 text-center absolute left-8 right-8 transform
          ...
          <div className="px-4 group sm:mb-9 lg:mb-9 mb-16 relative">
            <img className='w-full transition duration-300 group-hover:skew-y-[5deg] rounded-lg hover:skew-y-6 ' src={img7} alt="" />
            <div className="bg-skin-dark-light rounded-lg p-4 text-center absolute left-8 right-8 transform
             translate-y-1/2 bottom-0 pointer-events-none transition duration-300 group-hover:bg-[#eaa023] group-hover:-translate-y-4 ">
          ...
          <div className="px-4 group sm:mb-9 lg:mb-9 relative">
            <img className='w-full transition duration-300 group-hover:skew-y-[5deg] rounded-lg hover:skew-y-6 ' src={img2} alt=""/>
            <div className="bg-skin-dark-light rounded-lg p-4 text-center absolute left-8 right-8 transform
